...
<div class="min-height-200px">
            ...
            <div class="col-md-6 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Users Managements</li>
                    </ol>
                </nav>
            </div>
            <div class="col-md-6 col-sm-12 text-right">
                @can('user-create')
                <button type="button" class="btn btn-primary" onclick="create('{{ route('users.create') }}');">
                   <i class="icon-copy fa fa-plus"></i> Create Users
               </button>
               @endcan
            </div>
        </div>
    ...
    <div class="card-box mb-30">
        ...
        <div class="pb-20">
            <table class="data-table table stripe hover nowrap" id="datatables" data-users="{{ route('users.index') }}">
                <thead>
                    <tr>
