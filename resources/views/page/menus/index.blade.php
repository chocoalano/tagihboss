...
<div class="min-height-200px">
    <div class="page-header">
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="title">
                    <h4>Menu Managements</h4>
                </div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Menu Managements</li>
                    </ol>
                </nav>
            </div>
            <div class="col-md-6 col-sm-12 text-right">
                @can('menu-create')
                <button type="button" class="btn btn-primary" onclick="create('{{ route('menus.create') }}');">
                   <i class="icon-copy fa fa-plus"></i> Create Menu
               </button>
               @endcan
            </div>
        </div>
    ...
    <div class="card-box mb-30">
        ...
        <div class="pb-20">
            <table class="data-table table stripe hover nowrap table-sm" id="datatables" data-menus="{{ route('menus.index') }}">
                <thead>
                    <tr>
                        <th class="table-plus datatable-nosort" width="10">No</th>
                        <th>Menu Name</th>
                        <th>Menu Link</th>
                        <th>Menu Authorization</th>
                        <th>Menu Type</th>
...
<script src="{{ asset('js/page/menus.js') }}"></script>
@endsection
