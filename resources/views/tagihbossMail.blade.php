              ...
              <table class="force-full-width" cellspacing="0" cellpadding="0" bgcolor="#232925">
                <tr>
                  <td style="background-color:#232925" class="logo">
                    <br>
                    <!-- <a href="#"><img src="{{asset('ficwhite.png')}}" alt="Logo" width="5%"> <strong>TagihBoss</strong> </a> -->
                    <a href="#"><strong>TagihBoss</strong> </a>
                  </td>
                  <td class="icons">
                    <!-- <br>
              ...
              <table cellspacing="0" cellpadding="0" class="force-full-width" bgcolor="#232925">
                <tr>
                  ...
                  <td style="color: #ffffff;" class="header-text">
                    <br>
                    <br>
                    <span style="font-size: 24px;">Pemberitahuan data {{ $event }} baru!</span><br><br>
                    User atas nama {{ $name }} dengan email {{ $email }} telah membuat {{ $event }}, anda bisa melihat data tersebut sekarang. 
                    <br>
                    <br>
                      <div><!--[if mso]>
                        ...
                        <![endif]-->
                            <a href="{{url('/home')}}"
                        style="background-color:#2b934f;color:#ffffff;display:inline-block;font-family:Helvetcia, sans-serif;font-size:16px;font-weight:light;line-height:40px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;">Lihat data sekarang</a>
                          <!--[if mso]>
                            </center>
                          </v:rect>
                        <![endif]-->
                    ...
                    <table cellspacing="0" cellpadding="0" class="force-full-width">
                      <tr>
                        <td>
                          ...
                          Account name: <a href="#">{{ $name }}</a> <br>
                          Email: <a href="#">{{ $email }}</a> <br><br>
              ...
              <table class="force-full-width" cellspacing="0" cellpadding="20" bgcolor="#2b934f">
                <tr>
                  <td style="background-color:#2b934f; color:#ffffff; font-size: 14px; text-align: center;">
                    ©TagihBoss {{date('Y')}} All Rights Reserved
                  </td>
                </tr>
              </table>
